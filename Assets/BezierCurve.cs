...
public class BezierCurve : MonoBehaviour
{
    ...
    BezierCurve()
    {
  //      B = startPoint.position + new Vector3(5, 0, 5);
   //     startControlPoint = new GameObject();
  //      Instantiate(startControlPoint, B, Quaternion.identity);
  //      endControlPoint = new GameObject();
  //      C = endPoint.position + new Vector3(5, 0, 5);
  //      Instantiate(endControlPoint, C, Quaternion.identity);
    ...
    void OnDrawGizmos()
    {
        ...
        B = startControlPoint.position;
        C = endControlPoint.position;
        D = endPoint.position;
